...
const BUNDLE_ID = 'com.alexdev.expostarter'; // ios bundle id
const PACKAGE = 'com.alexdev.expostarter'; // android package name
const NAME = 'StarterKit'; // app name
const EXPO_ACCOUNT_OWNER = 'starterKit'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'starterkitApp'; // app scheme
